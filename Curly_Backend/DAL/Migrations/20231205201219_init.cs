        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FavorsId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppointmentFavor", x => new { x.AppointmentId, x.FavorsId });
                    table.ForeignKey(
                        name: "FK_AppointmentFavor_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppointmentFavor_Favors_FavorsId",
                        column: x => x.FavorsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentFavor_FavorsId",
                table: "AppointmentFavor",
                column: "FavorsId");
